...
<%-- 	<body background="<c:url value='/resources/images/4.jpg'/>"rel="images"> --%>
	<!-- Google fonts -->
...
<section class="main">
	<div class="layer">
		...
		<h1><img src="<c:url value="/resources/images/projectlogo.png"  />"/></h1>
			</div>
			<div class="links">
				<ul class="links-unordered-list">
					...
					<li class="">
					<button class="drop">Login</button>
						 <div class="dropdown">
    					<a href="../user/loginForm">Customer</a>
    					<a href="../retailer/loginForm">Retailer</a>
  					</div>
					</li>
					<li class="">
					<button class="dropbtn">Create Account</button>
						 <div class="dropdown-content">
    					<a href="../userReg/showForm">Customer</a>
    					<a href="../retailerReg/showFormRetailer">Retailer</a>
  					</div>
					</li>
					<li class="">
		...
		<div class="content-w3ls">
			...
			<div class="content-bottom">
				<form action="loginUser" name="forms" method="post"  modelAttribute="user">
